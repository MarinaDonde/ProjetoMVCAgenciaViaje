...
namespace AgenciaViaje.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,Cidade,Hotel,Dias,Valor")] Destino destino)
        {      
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,Cidade,Hotel,Dias,Valor")] Destino destino)
        {
